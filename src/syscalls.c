...
const syscalls_t syscalls_list[] =
{
        ...
        {"pipe", 1, {"int[2]"}, "int"},
        {"select", 5,
        {"int", "fd_set *", "fd_set *", "fd_set *", "stuct timeval *"},
        "int"},
        ...
        {"semtimedop", 4,
        {"int", "struct sembuf *", "unsigned int", "struct timespec *"},
        "int"},
        ...
        {"epoll_wait", 4, {"int", "struct epoll_event *", "int", "int"},
        "int"},
        ...
        {"set_mempolicy", 3, {"int", "unsigned long *", "unsigned long"},
        "int"},
        {"get_mempolicy", 5,
        {"int *", "unsigned long *", "unsigned long",
        ...
        "struct timespec *", "sigset_t *"}, "int"},
        {"unshare", 1, {"int"}, "int"},
        {"set_robust_list", 2, {"struct robust_list_head *", "size_t"},
        "long"},
        {"get_robust_list", 5,
        {"int", "char *", "int", "char *", "int"}, "int"},
        {"splice", 6 ,
